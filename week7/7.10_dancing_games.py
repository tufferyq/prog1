...
def calculate_average(dictionary):
    """
    this function calculates the average of the values of a dictionary
    :param dictionary: dict, the values are float
    :return average: float, average of all the values of the dict
    """
