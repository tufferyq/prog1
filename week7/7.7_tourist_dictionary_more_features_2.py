...
def dictionary_reversed(dictionary):
    """
    this function defines a new dictionary based on the one given as
    parameter. The key will be the values of the initial dictionary,
    and the values will be the keys of the initial one.
    :param dictionary: dictionary, initial dictionary
    :return reverted_dictionary: dictionary, reverted dictionary
    """
    reverted_dictionary = {}
    for row in dictionary:
        reverted_dictionary[dictionary[row]] = row
...
def main():
    ...
    while True:
        ...
        if command == "W":
            ...
            spanish_english = dictionary_reversed(english_spanish)

            for row in sorted(spanish_english):
                print(row, spanish_english[row])
